    ...
    <div class="container">
        ...
        <main>
            <div class="body-text">
                ...
                <p>Dear <span>{{ $update['name'] }}</span>,</p>
                {{-- Profie --}}
                @if ($update['type'] == 'profile')
                A new profile has been updated. Kindly approve
                @endif

                @if ($update['type']=== 'update_institution')
                An institution has been updated. Kindly approve.
                @endif

                @if ($update['type']=== 'certificate')
                A new certificate has been updated.<br>Kindly approve
                @endif
