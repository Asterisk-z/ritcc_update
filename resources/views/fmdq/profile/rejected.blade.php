            ...
            <div class="content-page-header">
                ...
                <div class="list-btn">
                    ...
                    <ul class="filter-list">
                        ...
                        <li>
                            <a class="btn btn-primary" href="{{ route('profile.rejected') }}"><i
                    ...
                    <ul class="filter-list">
                        ...
                        <li>
                            <a class="btn btn-primary" href="{{ route('inputter.profile.rejected') }}"><i
                                    class="fa fa-times me-2" aria-hidden="true"></i>Rejected</a>
                        </li>
                    </ul>
                    @endif
                    ...
                    <ul class="filter-list">
                        ...
                        <li>
                            <a class="btn btn-primary" href="{{ route('authoriser.profile.rejected') }}"><i
                                    class="fa fa-times me-2" aria-hidden="true"></i>Rejected</a>
                        </li>
                    </ul>
                    @endif
