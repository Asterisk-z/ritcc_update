<td class="d-flex align-items-center">
    <div class="dropdown dropdown-action">
        ...
        <div class="dropdown-menu dropdown-menu-right">
            <ul>
                <li>
                    <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#view{{ $security->id }}" href=""><i
                            class="far fa-edit me-2"></i>View</a>

                </li>
                @if (auth()->user()->type === 'inputter' && $security->approvedBy)
                <li>
                    <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#edit{{ $security->id }}" href=""><i
