                            ...
                            <table class="datatable table table-center table-stripped table-bordered" id="example2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @php
                                        $updateCertificate = $certificate->modifyingFlag ? json_decode($certificate->modifyingData) : [];

                                        @endphp
                                        <td>{{ $certificate->modifyingFlag ? $updateCertificate->securityCode : $certificate->securityCode }}</td>
                                        <td>{{ $certificate->modifyingFlag ? $updateCertificate->auctioneerEmail : $certificate->auctioneer->email }}</td>
                                        <td>{{ $certificate->modifyingFlag ? $updateCertificate->isinNumber : $certificate->isinNumber }}</td>
                                        <td>{{ $certificate->modifyingFlag ? $updateCertificate->issuerCode : $certificate->issuerCode }}</td>
                                        <td>{{ $certificate->modifyingFlag ? $updateCertificate->offerAmount : $certificate->offerAmount }}</td>
                                        <td>{{ $certificate->modifyingFlag ? date('F d, Y',strtotime($updateCertificate->createdDate)) : date('F d, Y',strtotime($certificate->createdDate))}}</td>
                                        <td><span class="badge bg-3"> {{ $certificate->modifyingFlag ? 'Pending Update' : 'Pending Delete' }}</span></td>
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul>
                                                        ...
                                                        @if ($certificate->modifyingFlag)
                                                        <li>
                                                            <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#approveUpdate{{ $certificate->id }}" href=""><i class="fa fa-check me-2"></i>Approve Update</a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#rejectUpdate{{ $certificate->id }}" href=""><i class="fa fa-times me-2"></i>Reject Update</a>
                                                        </li>
                                                        @endif

                                                        @if ($certificate->deletingFlag)
                                                        <li>
                                                            <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#approveDelete{{ $certificate->id }}" href=""><i class="fa fa-check me-2"></i>Approve Delete</a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#rejectDelete{{ $certificate->id }}" href=""><i class="fa fa-times me-2"></i>Reject Delete</a>
                                                        </li>
                                                        @endif
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="text-center">
                                                            <h6>Security Code : <strong>{{ $updateCertificate->securityCode  }}</strong></h6>
                                                            <br>
                                                            <h6>Offer Amount : <strong>{{ $updateCertificate->offerAmount  }}</strong></h6>
                                                            <br>
                                                            <h6>Auctioneer Email : <strong>{{ $updateCertificate->auctioneerEmail  }}</strong></h6>
                                                            <br>
                                                            <h6>Security ISIN NUmber : <strong>{{ $updateCertificate->isinNumber  }}</strong></h6>
                                                            <br>
                                                            <h6>Issue Date: <strong>{{ date('F d, Y h:m:s',strtotime($updateCertificate->issueDate )) }}</strong></h6>
                                                            <br>
                                                            <h6>Inputter: <strong>{{ $updateCertificate->createdBy  }}</strong></h6>
                                                            <br>
                                                            <h6>Created Date: <strong>{{ date('F d, Y h:m:s',strtotime($updateCertificate->createdDate ))}}</strong></h6>
                                                        </div>
                                                    </div>
                                        ...
                                        <div id="approveUpdate{{ $certificate->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('certificate.mgt.approve.update') }}" method="POST" class="needs-validation" id="update" novalidate>
                                                        @csrf
                                        ...
                                        <div id="rejectUpdate{{ $certificate->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('certificate.mgt.reject.update') }}" method="POST" class="needs-validation" id="myForm" novalidate>
                                                        @csrf
                                                        <input type='hidden' name='security_ref' value="{{ $certificate->id }}" />
                                                        <div class="modal-body">
                                        ...
                                        <div id="approveDelete{{ $certificate->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('certificate.mgt.approve.delete') }}" method="POST" class="needs-validation" id="update" novalidate>
                                                        @csrf
                                                        <input type='hidden' name='security_ref' value="{{ $certificate->id }}" />
                                                        <div class="modal-body">
                                        ...
                                        <div id="rejectDelete{{ $certificate->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('certificate.mgt.reject.delete') }}" method="POST" class="needs-validation" id="myForm" novalidate>
                                                        @csrf
                                                        <input type='hidden' name='security_ref' value="{{ $certificate->id }}" />
                                                        <div class="modal-body">
                                                            <label for="">Reason for Rejection</label>
                                        ...
                                        <div id="approve{{ $certificate->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('certificate.mgt.approve.create') }}" method="POST" class="needs-validation" id="update" novalidate>
                                                        @csrf
                                                        <input type='hidden' name='security_ref' value="{{ $certificate->id }}" />
                                                        <div class="modal-body">
                                        ...
                                        <div id="reject{{ $certificate->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('certificate.mgt.reject.create') }}" method="POST" class="needs-validation" id="myForm" novalidate>
                                                        @csrf
                                                        <input type='hidden' name='security_ref' value="{{ $certificate->id }}" />
                                                        <div class="modal-body">
                                                            <label for="">Reason for Rejection</label>
                                        ...
                                        <div id="view{{ $certificate->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="text-center">
                                                            <h6>Security Code : <strong>{{ $certificate->securityCode }}</strong></h6>
                                                            <br>
                                                            <h6>Offer Amount : <strong>{{ $certificate->offerAmount }}</strong></h6>
                                                            <br>
                                                            <h6>Auctioneer Email : <strong>{{ $certificate->auctioneerEmail }}</strong></h6>
                                                            <br>
                                                            <h6>Security ISIN NUmber : <strong>{{ $certificate->isinNumber }}</strong></h6>
                                                            <br>
                                                            <h6>Issue Date: <strong>{{ date('F d, Y h:m:s',strtotime($certificate->issueDate )) }}</strong></h6>
                                                            <br>
                                                            <h6>Inputter: <strong>{{ $certificate->createdBy }}</strong></h6>
                                                            <br>
                                                            <h6>Created Date: <strong>{{ date('F d, Y h:m:s',strtotime($certificate->createdDate))}}</strong></h6>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary btn-lg" data-bs-dismiss="modal">Close</button>
