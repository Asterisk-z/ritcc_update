    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="content-page-header">
                ...
                <button type="button" class="btn btn-primary mt-1" data-bs-toggle="modal" data-bs-target="#standard-modal"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Auction Bid</button>
                {{-- modal --}}
                <div id="standard-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('trade.mgt.create') }}" method="POST" id="myForm" class="needs-validation" novalidate>
                                @csrf
                                <div class="modal-body">
                                    <div class="form-row row">
                                        {{-- code --}}
                                        <div class="col-md-12 mb-3">
                                            <label for="validationCustom01">Certificate</label>
                                            <select name="certificate" id="validationCustom01" class="form-control" required>
                                                <option value="">--Select--</option>
                                                @forelse ($auctions as $auction)
                                                <option value="{{ $auction->id }}">{{ $auction->security->securityCode ." | ".$auction->security->issuerCode }}</option>
                                                @empty
                                                @endforelse
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" name="settlementAccount" class="form-control" id="validationCustom01" required>
                                            <div class="invalid-feedback">
                                                This field is required
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" name="nominalAmount" class="form-control" id="validationCustom01" required>
                                            <div class="invalid-feedback">
                                                This field is required
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="number" name="discountRate" class="form-control" id="validationCustom01" required>
                                            <div class="invalid-feedback">
                                                This field is required
                                            </div>
                                        </div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="text-center">
                                                            <h6>Security Name : <strong>{{ $bid->auction->security->description  }}</strong></h6>
                                                            <br>
