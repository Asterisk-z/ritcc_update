            ...
            <div class="content-page-header">
                ...
                <div class="list-btn">
                    ...
                    <ul class="filter-list">
                        ...
                        <li>
                            <a class="btn btn-primary" href="{{ route('institution.approved') }}"><i
                    ...
                    <ul class="filter-list">
                        ...
                        <li>
                            <a class="btn btn-primary" href="{{ route('inputter.institution.approved') }}"><i
                                    class="fa fa-check me-2" aria-hidden="true"></i>Approved</a>
                        </li>
                        <li>
                    ...
                    <ul class="filter-list">
                        ...
                        <li>
                            <a class="btn btn-primary" href="{{ route('authoriser.institution.approved') }}"><i
                                    class="fa fa-check me-2" aria-hidden="true"></i>Approved</a>
                        </li>
                        <li>
