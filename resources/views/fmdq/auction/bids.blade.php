                            ...
                            <table class="datatable table table-center table-stripped table-bordered" id="example1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a class="dropdown-item" data-bs-toggle="modal"
                                                                data-bs-target="#view{{ $item->id }}" href=""><i
                                                                    class="far fa-edit me-2"></i>View</a>
                                                        </li>
                                                        @if(!$item->awardedFlag)
                                                        <li>
                                                            <a class="dropdown-item" data-bs-toggle="modal"
                                                                data-bs-target="#award{{ $item->id }}" href=""><i
                                                                    class="far fa-edit me-2"></i>Award Offer</a>
                                                        </li>
                                                        @else
                                                        <li>
                                                            <a class="dropdown-item" data-bs-toggle="modal"
                                                                data-bs-target="#cancel{{ $item->id }}" href=""><i
                                                                    class="far fa-edit me-2"></i>Cancel Award</a>
                                                        </li>
                                                        @endif
                                                    </ul>
                                                </div>
                                        ...
                                        <div id="view{{ $item->id }}" class="modal fade" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="text-center">
                                                            <h6>Security Code : <strong>{{ $item->securityCode
                                                                    }}</strong></h6>
                                                            <br>
                                                            <h6>Offer Amount : <strong>{{ $item->offerAmount }}</strong>
                                                            </h6>
                                                            <br>
                                                            <h6>Auctioneer Email : <strong>{{ $item->auctioneerEmail
                                                                    }}</strong></h6>
                                                            <br>
                                                            <h6>Security ISIN NUmber : <strong>{{ $item->isinNumber
                                                                    }}</strong></h6>
                                                            <br>
                                                            <h6>Ofer Date : <strong>{{ $item->offerDate }}</strong></h6>
                                                            <br>
                                                            <h6>Auction Start Time : <strong>{{ date('F d, Y
                                                                    h:m:s',strtotime($item->auctionStartTime))
                                                                    }}</strong></h6>
                                                            <br>
                                                            <h6>Bid Close Time : <strong>{{ date('F d, Y
                                                                    h:m:s',strtotime($item->bidCloseTime)) }}</strong>
                                                            </h6>
                                                            <br>
                                                            <h6>Bid Result Time : <strong>{{ date('F d, Y
                                                                    h:m:s',strtotime($item->bidResultTime)) }}</strong>
                                                            </h6>
                                                            <br>
                                                            <h6>Minimum Rate : <strong>{{ $item->minimumRate }}</strong>
                                                            </h6>
                                                            <br>
                                                            <h6>Maximum Rate : <strong>{{ $item->maximumRate }}</strong>
                                                            </h6>
                                                            <br>
                                                            <h6>Inputter: <strong>{{ $item->createdBy }}</strong></h6>
                                                            <br>
                                                            <h6>Created Date: <strong>{{ date('F d, Y
                                                                    h:m:s',strtotime($item->createdDate))}}</strong>
                                                            </h6>
                                                        </div>
                                                    </div>
                                        ...
                                        <div id="award{{ $item->id }}" class="modal fade" tabindex="-1" role="dialog"
                                            aria-labelledby="standard-modalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-row row">
                                                                <div class="col-md-12 mb-3">
                                                                    ...
                                                                    <input type="number" name="award_amount"
                                        ...
                                        <div id="cancel{{ $item->id }}" class="modal fade" tabindex="-1" role="dialog"
                                            aria-labelledby="standard-modalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
